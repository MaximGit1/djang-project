# Generated by Django 5.0.1 on 2024-03-10 16:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_image', models.ImageField(upload_to='books/%Y/%md0y5c5d3a7t7', verbose_name='Обложка книги')),
                ('fb2_path', models.FileField(upload_to='books/%Y/%md0y5c5d3a7t7', verbose_name='fb2 файл')),
                ('epub_path', models.FileField(blank=True, upload_to='books/%Y/%md0y5c5d3a7t7', verbose_name='epub файл')),
                ('mp3_path', models.FileField(blank=True, upload_to='books/%Y/%md0y5c5d3a7t7', verbose_name='mp3 файл')),
