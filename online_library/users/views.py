...
class LoginUser(LoginView):
    ...
    extra_context = {**DATA, 'title': 'Авторизация'}
...
def register_users(request):
    ...
    return render(request, 'users/register.html', {**DATA, 'form': form})
...
def profile(request):
    ...
    context = {**DATA, 'title': 'Личный кабинет', 'user': request.user, 'lk_books': lk_books, 'form': form}
...
def other_profile(request, id_user):
    ...
    context = {**DATA, 'title': 'Профиль', 'user': user_sel, 'lk_books': lk_books}
